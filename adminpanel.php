		  ...
		  <header id="header" id="home">
			...
			<div class="container">
				<div class="row align-items-center justify-content-between d-flex">
				  <div id="logo">
					<a href="adminpanel.html"><img src="" alt="" title="Digital Museum" /></a>
				  </div>
				  <nav id="nav-menu-container">
					<ul class="nav-menu">
					  <li class="menu-active"><a href="adminpanel.html">Home</a></li>
                      ...
                      <li><a href="artifacts.html">Add Artifacts</a></li>
